...
class NeuralNetwork:
	...
	learning_rate):
        ...
        self.wh3h4 = np.random.normal(0.0, pow(self.hnodes, -0.5), \
            (self.hnodes, self.hnodes))      
        self.wh4o = np.random.normal(0.0, pow(self.hnodes, -0.5), \
    ...
    def train(self, inputs_list, targets_list):
        ...
        self.wh4o += self.lr * np.dot((output_errors * final_outputs * \
